...
} from "@/components/screening/UploadJobDescriptionSchema";
import { formatBytes } from "@/components/screening/screeningLib/utils";
...
type UploadJobDescriptionCardProps = {
  ...
  onCancel: () => void;
  onStartProcessing: (input: JobDescriptionInput) => void;
};
