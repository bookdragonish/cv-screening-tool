...
function Screening() {
  ...
  return (
    <main className="min-h-screen px-8 py-6">
      ...
      {isLoading && (
        <div className="rounded-lg border border-(--color-primary) bg-(--color-white) p-6 shadow-sm">
      ...
      {!isLoading && (isError || !data) && (
        <div className="rounded-lg border border-(--color-primary) bg-(--color-white) p-6 shadow-sm">
          ...
          <Link
            to="/screening-historikk"
            className="mt-4 inline-block rounded-lg bg-(--color-primary) px-4 py-2 font-medium text-(--color-white)"
          >
            Tilbake
          </Link>
        </div>
        ...
        <div className="space-y-4">
          ...
          {data.candidates.map((candidate) => (
            <div
              ...
              className="rounded-lg border border-(--color-primary) bg-(--color-white) p-6 shadow-sm"
            >
