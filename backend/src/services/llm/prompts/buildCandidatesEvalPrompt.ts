...
- Om kandidaten har en kvalifikasjon fra must_haves, skal den listes i strengths med en forklaring.
...
<qualification_rules>
- strengths.point, gaps.point og unknowns[] MÅ være eksakt tekst fra job_profile_json.must_haves.
...
- overall_score skal kun baseres på andelen kvalifikasjoner i must_haves som er oppfylt.
</qualification_rules>
